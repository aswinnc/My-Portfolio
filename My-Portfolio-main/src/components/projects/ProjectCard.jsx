  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={`h-0.5 hidden sm:block absolute top-1/2 ${isEven ? "left-1/2 right-1/4" : "left-1/4 right-1/2"
            }`}
        ...
        {/* Project image */}
        <motion.div
          className={`flex w-full relative justify-center ${!isEven ? "sm:order-2 sm:justify-end" : "sm:justify-start"
            }`}
