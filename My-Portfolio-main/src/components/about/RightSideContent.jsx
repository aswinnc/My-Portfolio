    ...
    <div className="lg:w-1/2">
      <div className="sticky top-24">
        <div className="mb-10">
          ...
          >
            <ul
              className="text-lg leading-relaxed list-none p-0 m-0 space-y-4"
            ...
            >
              ...
              <li>
                <Highlight>Python Full Stack, Django, MySQL</Highlight>:
                Building robust backend architectures. I specialize in both
                traditional REST APIs (Django/MySQL) and modern serverless
              ...
              <li>
                <Highlight>Redux Toolkit, Zod</Highlight>:
                Managing complex application state and enforcing strict data
                validation. I ensure robust data flow with optimized state management and
                type integrity.
              </li>
              ...
              <li>
                <Highlight>Code Quality & Standards</Highlight>: I ensure
                enterprise-grade code quality by enforcing consistent standards
                and using strict validation to prevent bugs.
              </li>
            </ul>
          </div>
        </div>
