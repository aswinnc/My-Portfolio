      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="flex flex-col">
            ...
            >
              ...
              >
                Python Developer • Full Stack Solutions
              </p>
            </motion.div>
            ...
            <motion.p
              ...
              style={{ color: themeColors.summeryText }}
            >
              I build efficient, user-friendly applications using Python, React, and Django, delivering results in real-world scenarios.
            </motion.p>
          </div>
          ...
          <div className="flex flex-col items-center lg:items-end">
            ...
            >
              <p
                ...
                style={{ color: themeColors.summeryText }}
              >
                Let’s stay connected — I post updates and projects.
              </p>
          ...
          >
            <p
              ...
              style={{ color: themeColors.summeryText }}
            >
              Open to freelance, consulting, or just a tech chat.
            </p>
            <motion.a
              href="https://www.linkedin.com/in/aswin-nc"
              target="_blank"
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <motion.p
            ...
            style={{ color: themeColors.summeryText }}
          >
            © {new Date().getFullYear()} <a href="https://www.linkedin.com/in/aswin-nc"><span style={{ color: themeColors.primaryColor }}>Aswin N C</span></a> · Coded with intent,
            designed with care.
          </motion.p>
